...
const AsyncStepProtector = require( './asyncstep_protector.js' );
const ParallelStep = require( './parallel_step.js' );
...
exports.assertAS = function( as ) {
    if ( as instanceof AsyncSteps ||
         as instanceof AsyncStepProtector ||
         as instanceof ParallelStep
    ) {
        return;
    }

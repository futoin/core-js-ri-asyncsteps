...
( function( window ) {
    ...
    if ( typeof futoin.AsyncSteps === 'undefined' )
    {
         ...
         * @global
         * @name window.futoin.Mutex
         */
        futoin.Mutex = require( '../Mutex' );

        /**
         * **window.futoin.Throttle** - browser-only reference to futoin-asyncsteps.Throttle
         * @global
         * @name window.futoin.Throttle
         */
        futoin.Throttle = require( '../Throttle' );

        /**
         * **window.futoin.Limiter** - browser-only reference to futoin-asyncsteps.Limiter
         * @global
         * @name window.futoin.Limiter
         */
        futoin.Limiter = require( '../Limiter' );

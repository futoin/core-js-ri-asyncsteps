 ...
 * @returns {AsyncSteps} Protected step instance
 */
exports = module.exports = function( root )
{
    return new module.exports.AsyncStepProtector( root );
};
 ...
 */
ASPProto.waitExternal = function( )
{
